...
(function lazyFormsContentScript() {
  /** Avoid duplicate init: manifest injection + programmatic inject on extension install both run in the same isolated world. */
  const INIT_KEY = '__lazyFormsContentScriptInit';
